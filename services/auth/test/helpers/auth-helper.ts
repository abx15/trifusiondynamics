...
const JWT_SECRET = process.env.JWT_ACCESS_SECRET || 'd5f8b9e67c8a49c2a12a7f5a3b9d0e1c4b7a8d9e0f1a2b3c4d5e6f7a8b9c0d1e';
...
const ROLE_PERMISSIONS: Record<string, string[]> = {
  admin: [
    ...
    'developer:read', 'developer:write', 'developer:delete',
