    ...
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">Build a client proposal</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
        <div className="rounded-xl border border-border bg-card p-6 space-y-4">
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <div className="col-span-3">
              ...
              <textarea {...register("notes")} rows={2} className="w-full rounded-lg border border-border bg-background px-3 py-2.5 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary/50 resize-none" placeholder="Payment terms, scope notes..." />
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center justify-end gap-3">
          <Link href="/crm/quotes" className="rounded-lg border border-border px-4 py-2.5 text-sm font-medium text-foreground hover:bg-slate-50 dark:hover:bg-zinc-900 transition-colors">Cancel</Link>
