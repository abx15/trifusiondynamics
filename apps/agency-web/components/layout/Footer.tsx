...
export default function Footer() {
  ...
  return (
    <footer className="w-full border-t border-white/5 bg-[#03060c] py-12 sm:py-16 text-slate-400">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 sm:gap-12 mb-12">
          ...
          <div className="flex flex-col gap-4 sm:col-span-2 lg:col-span-1">
            ...
            <div className="flex gap-4 mt-2">
              ...
              <a href="#" className="hover:text-primary transition-colors p-1" aria-label="Twitter / X">
                <svg className="h-5 w-5 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                </svg>
              </a>
              <a href="#" className="hover:text-primary transition-colors p-1" aria-label="GitHub">
                <svg className="h-5 w-5 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          {/* Contact Details */}
          <div className="flex flex-col gap-4">
            <h3 className="font-display font-semibold text-white text-sm uppercase tracking-wider">Get in Touch</h3>
            <ul className="flex flex-col gap-3.5 text-sm">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="tel:+918745883950" className="hover:text-white transition-colors">
                  +91 8745883950
                </a>
              </li>
        ...
        <div className="border-t border-white/5 pt-8 flex flex-col sm:flex-row items-center justify-between text-xs text-slate-500 gap-2">
          <p>© {currentYear} Trifusion Dynamics. All rights reserved.</p>
          <p>Designed for fast-growing businesses.</p>
        </div>
      </div>
    </footer>
  );
